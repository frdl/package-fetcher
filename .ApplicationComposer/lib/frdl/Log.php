...
namespace frdl;
	...
	*
	*  edited by webfan.de
	*    @ToDo     write to cache dir and manage cache dir...
	*
	*/
	class Log {
			...
			public function __construct() {
				...
				trigger_error('@ToDO: Loc functionallity and pruning in '.__METHOD__.' '.__LINE__, E_USER_DEPRECATED);
			}
		    ...
		    */	
			public function write($message) {
		    	...
		    	return trigger_error('SQL log: '.$message, E_USER_NOTICE);
